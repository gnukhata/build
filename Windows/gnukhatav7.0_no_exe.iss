...
#define MyAppExeName "startgnukhata.bat"
...
[Files]
Source: "C:\gnukhatav7.0\startgnukhata.bat"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\gnukhatav7.0\gkinit.bat"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\gnukhatav7.0\gkinit.vbs"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\gnukhatav7.0\gkwebapp.bat"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\gnukhatav7.0\database.bat"; DestDir: "{app}"; Flags: ignoreversion
...
Filename: "{app}\gkinit.bat"; Flags: runhidden
Filename: "{app}\{#MyAppExeName}"; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; Flags: shellexec postinstall runhidden waituntilidle

[Registry]
Root: HKLM; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; ValueType: string; ValueName: "GNUKhata"; ValueData: "{app}\gkinit.vbs"
